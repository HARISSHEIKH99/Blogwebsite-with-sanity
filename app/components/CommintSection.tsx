...
const CommentSection = () => {
  ...
  return (
    <div className="comment-section mt-10 p-6 max-w-5xl mx-auto bg-white shadow-lg rounded-lg ]">
...
//  return(
//     <div className='commemt-section mt-10 p-6 max-w-2xl mx-auto bg-whiteshadow-lg rounded-lg'>
// <h3 className='font-bold text-2xl text-[#2b5474] mb-4'> Add a Comment</h3>
